...
public class KafkaReader {
    ...
    public KafkaReader(final String zookeeperConnect, String topic, String groupId, String offsetReset) {
    ...
    protected void initKafkaStream() {
        ...
        Consumer.createJavaConsumerConnector(new ConsumerConfig(this.props));
